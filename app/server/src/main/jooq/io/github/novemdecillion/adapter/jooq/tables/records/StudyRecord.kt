...
open class StudyRecord() : UpdatableRecordImpl<StudyRecord>(StudyTable.STUDY), Record11<UUID?, UUID?, String?, StudyStatus?, JSONB?, Int?, JSONB?, JSONB?, JSONB?, OffsetDateTime?, OffsetDateTime?>, IStudy {
    ...
    override fun valuesRow(): Row11<UUID?, UUID?, String?, StudyStatus?, JSONB?, Int?, JSONB?, JSONB?, JSONB?, OffsetDateTime?, OffsetDateTime?> = super.valuesRow() as Row11<UUID?, UUID?, String?, StudyStatus?, JSONB?, Int?, JSONB?, JSONB?, JSONB?, OffsetDateTime?, OffsetDateTime?>
    ...
    override fun values(value1: UUID?, value2: UUID?, value3: String?, value4: StudyStatus?, value5: JSONB?, value6: Int?, value7: JSONB?, value8: JSONB?, value9: JSONB?, value10: OffsetDateTime?, value11: OffsetDateTime?): StudyRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(studyId: UUID? = null, accountId: UUID? = null, slideId: String? = null, status: StudyStatus? = null, progress: JSONB? = null, progressRate: Int? = null, answer: JSONB? = null, score: JSONB? = null, shuffledQuestion: JSONB? = null, startAt: OffsetDateTime? = null, endAt: OffsetDateTime? = null): this() {
