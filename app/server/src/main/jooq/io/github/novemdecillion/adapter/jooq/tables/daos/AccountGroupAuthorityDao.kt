...
open class AccountGroupAuthorityDao(configuration: Configuration?) : DAOImpl<AccountGroupAuthorityRecord, AccountGroupAuthorityEntity, Record3<UUID?, UUID?, Role?>>(AccountGroupAuthorityTable.ACCOUNT_GROUP_AUTHORITY, AccountGroupAuthorityEntity::class.java, configuration) {
    ...
    override fun getId(o: AccountGroupAuthorityEntity): Record3<UUID?, UUID?, Role?>? = compositeKeyRecord(o.accountId, o.groupTransitionId, o.role)
