...
open class RealmRecord() : UpdatableRecordImpl<RealmRecord>(RealmTable.REALM), Record4<String?, String?, Boolean?, OffsetDateTime?>, IRealm {
    ...
    override var syncAt: OffsetDateTime?
    ...
    override fun valuesRow(): Row4<String?, String?, Boolean?, OffsetDateTime?> = super.valuesRow() as Row4<String?, String?, Boolean?, OffsetDateTime?>
    ...
    override fun value4(value: OffsetDateTime?): RealmRecord {
        this.syncAt = value
        return this
    }

    override fun values(value1: String?, value2: String?, value3: Boolean?, value4: OffsetDateTime?): RealmRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(realmId: String? = null, realmName: String? = null, enabled: Boolean? = null, syncAt: OffsetDateTime? = null): this() {
