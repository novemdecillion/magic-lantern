...
open class CurrentAccountGroupAuthorityRecord() : TableRecordImpl<CurrentAccountGroupAuthorityRecord>(CurrentAccountGroupAuthorityTable.CURRENT_ACCOUNT_GROUP_AUTHORITY), Record4<UUID?, UUID?, Role?, UUID?>, ICurrentAccountGroupAuthority {
    ...
    override fun valuesRow(): Row4<UUID?, UUID?, Role?, UUID?> = super.valuesRow() as Row4<UUID?, UUID?, Role?, UUID?>
    ...
    override fun field3(): Field<Role?> = CurrentAccountGroupAuthorityTable.CURRENT_ACCOUNT_GROUP_AUTHORITY.ROLE
    ...
    override fun value3(value: Role?): CurrentAccountGroupAuthorityRecord {
        this.role = value
        return this
    }
    ...
    override fun values(value1: UUID?, value2: UUID?, value3: Role?, value4: UUID?): CurrentAccountGroupAuthorityRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(accountId: UUID? = null, groupTransitionId: UUID? = null, role: Role? = null, groupOriginId: UUID? = null): this() {
