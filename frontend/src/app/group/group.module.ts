...
@NgModule({
  declarations: [GroupListComponent, GroupTreeComponent, GroupPageComponent, EditGroupComponent, MemberListComponent, EditMemberComponent, NextGenerationComponent, ImportGroupComponent],
  imports: [
    CommonModule,
    GroupRoutingModule,
    ShareModule
