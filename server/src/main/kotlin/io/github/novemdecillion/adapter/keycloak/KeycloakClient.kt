...
open class KeycloakClient(protected val webClient: WebClient, private val realm: String, private val client: String) {
  companion object {
    val log = logger()
  }
...
class KeycloakAdminCliClient(webClient: WebClient) : KeycloakClient(webClient, "master", "admin-cli") {
  companion object {
    val log = logger()
  }
