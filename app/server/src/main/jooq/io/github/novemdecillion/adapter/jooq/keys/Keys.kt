...
val STUDY_ACCOUNT_ID_SLIDE_ID_INDEX_KEY: UniqueKey<StudyRecord> = Internal.createUniqueKey(StudyTable.STUDY, DSL.name("study_account_id_slide_id_index_key"), arrayOf(StudyTable.STUDY.ACCOUNT_ID, StudyTable.STUDY.SLIDE_ID, StudyTable.STUDY.INDEX), true)
