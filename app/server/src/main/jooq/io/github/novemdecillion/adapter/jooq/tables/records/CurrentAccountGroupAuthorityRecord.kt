...
open class CurrentAccountGroupAuthorityRecord() : TableRecordImpl<CurrentAccountGroupAuthorityRecord>(CurrentAccountGroupAuthorityTable.CURRENT_ACCOUNT_GROUP_AUTHORITY), Record4<UUID?, UUID?, Int?, JSONB?>, ICurrentAccountGroupAuthority {
    ...
    override fun field3(): Field<Int?> = CurrentAccountGroupAuthorityTable.CURRENT_ACCOUNT_GROUP_AUTHORITY.GROUP_GENERATION_ID
    override fun field4(): Field<JSONB?> = CurrentAccountGroupAuthorityTable.CURRENT_ACCOUNT_GROUP_AUTHORITY.ROLE
    ...
    override fun value3(value: Int?): CurrentAccountGroupAuthorityRecord {
        this.groupGenerationId = value
        return this
    }

    override fun value4(value: JSONB?): CurrentAccountGroupAuthorityRecord {
        this.role = value
        return this
    }

    override fun values(value1: UUID?, value2: UUID?, value3: Int?, value4: JSONB?): CurrentAccountGroupAuthorityRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
