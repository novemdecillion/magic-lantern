...
open class UserAggregateRecord() : TableRecordImpl<UserAggregateRecord>(UserAggregateTable.USER_AGGREGATE), Record9<UUID?, String?, String?, String?, String?, String?, String?, Boolean?, JSONB?>, IUserAggregate {
    ...
    override fun valuesRow(): Row9<UUID?, String?, String?, String?, String?, String?, String?, Boolean?, JSONB?> = super.valuesRow() as Row9<UUID?, String?, String?, String?, String?, String?, String?, Boolean?, JSONB?>
    ...
    override fun field9(): Field<JSONB?> = UserAggregateTable.USER_AGGREGATE.ROLE
    ...
    override fun component9(): JSONB? = role
    ...
    override fun value9(): JSONB? = role
    ...
    override fun value9(value: JSONB?): UserAggregateRecord {
        this.role = value
        return this
    }

    override fun values(value1: UUID?, value2: String?, value3: String?, value4: String?, value5: String?, value6: String?, value7: String?, value8: Boolean?, value9: JSONB?): UserAggregateRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(accountId: UUID? = null, accountName: String? = null, password: String? = null, userName: String? = null, email: String? = null, locale: String? = null, realmId: String? = null, enabled: Boolean? = null, role: JSONB? = null): this() {
